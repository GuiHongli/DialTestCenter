...
public class WssMessageDispatcherTest {
    ...
    private ByteBuffer createRegisterRequestBuffer(String hostname) {
        return TlvEncoder.encodeMessage(MessageType.REGISTER_REQUEST,
            java.util.Arrays.asList(TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.HOSTNAME, hostname)));
    }
    ...
    private ByteBuffer createRegisterResponseBuffer(int challengeId, String username, String response) {
        return TlvEncoder.encodeMessage(MessageType.REGISTER_RESPONSE,
            java.util.Arrays.asList(
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.CHALLENGE_ID, challengeId),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.USERNAME, username),
                TlvField.ofBytes(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESPONSE, response.getBytes())
            ));
    }
    ...
    private ByteBuffer createReportMsgBuffer(long token, String state) {
        return TlvEncoder.encodeMessage(MessageType.REPORT_MSG,
            java.util.Arrays.asList(
                TlvField.ofLong(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TOKEN, token),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.STATE, state),
                TlvField.ofContainer(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.UE_LIST, new byte[0])
            ));
    }
    ...
    private ByteBuffer createAppListResponseBuffer(String serialNo, int result) {
        return TlvEncoder.encodeMessage(MessageType.APP_LIST_RESPONSE,
            java.util.Arrays.asList(
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TOKEN, "dummy_token"),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.SERIAL_NO, serialNo),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESULT, result)
            ));
    }
    ...
    private ByteBuffer createAppInstallResponseBuffer(String serialNo, int taskId, int result) {
        return TlvEncoder.encodeMessage(MessageType.APP_INSTALL_RESPONSE,
            java.util.Arrays.asList(
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TOKEN, "dummy_token"),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.SERIAL_NO, serialNo),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TASKID, taskId),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESULT, result)
            ));
    }
    ...
    private ByteBuffer createScreencapResponseBuffer(String serialNo, int result, String filename, byte[] content) {
        return TlvEncoder.encodeMessage(MessageType.SCREENCAP_RESPONSE,
            java.util.Arrays.asList(
                ...
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.SERIAL_NO, serialNo),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESULT, result),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.FILENAME, filename),
                TlvField.ofBytes(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.CONTENT, content)
            ));
    }
    ...
    private ByteBuffer createScriptUpdateAckBuffer(String scriptName, String version, int result) {
        return TlvEncoder.encodeMessage(MessageType.SCRIPT_UPDATE_ACK,
            java.util.Arrays.asList(
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TOKEN, "dummy_token"),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.SCRIPT_NAME, scriptName),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.VERSION, version),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESULT, result)
            ));
    }
    ...
    private ByteBuffer createTaskStartResponseBuffer(int taskId, String result) {
        return TlvEncoder.encodeMessage(MessageType.TASK_START_RESPONSE,
            java.util.Arrays.asList(
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TOKEN, "dummy_token"),
                TlvField.ofInt(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.TASKID, taskId),
                TlvField.ofString(com.huawei.cloududn.dialingtest.controller.executormanagement.websocket.codec.FieldTag.RESULT, result)
            ));
    }
