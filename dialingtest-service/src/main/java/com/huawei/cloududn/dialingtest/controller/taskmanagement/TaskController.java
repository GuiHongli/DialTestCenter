...
import com.huawei.cloududn.dialingtest.service.taskmanagement.TaskTriggerService;
    ...
    public ResponseEntity<TaskEntity> startTask(@RequestBody StartTaskRequest body) {
        if (body == null) {
            ...
            if (businessType == null || String.valueOf(businessType).trim().isEmpty()) {
                ...
                com.huawei.cloududn.dialingtest.service.taskmanagement.dto.StartTaskRequest req = new com.huawei.cloududn.dialingtest.service.taskmanagement.dto.StartTaskRequest();
