...
│           ├── ScreencapQueryDto.java      // V3新增: 截屏查询 (0x25)
│           ├── ScreencapResponseDto.java   // V3新增: 截屏应答 (0x26)
│           │
...
- `controller.executormanagement.websocket.dto.ScreencapQueryDto.java`
- `controller.executormanagement.websocket.dto.ScreencapResponseDto.java`
